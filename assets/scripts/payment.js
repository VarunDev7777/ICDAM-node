...
document.querySelectorAll('.registeration_fee').forEach((ele, ind) => {
	ele.addEventListener("click", () => {
		switch (ind) {
			...
			case 3: handleOther();
				break;
			case 4: handlePay({ category: 'Research Scholar/Student', fee: '30000', mail: '' });
				break;
			case 5: handlePay({ category: 'Academician', fee: '35000', mail: '' });
				break;
			case 6: handlePay({ category: 'Industrial Participant', fee: '10000', mail: '' });
				break;
			case 7: handleOther();
				break;
		}
